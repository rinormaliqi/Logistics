...
const Hero: React.FC = () => {
      ...
      <div className='bg-gradient-to-b from-skyblue via-lightskyblue dark:via-[#4298b0] to-white/10 dark:to-black/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-5 2xl:px-0 pt-32 md:pt-60 md:pb-68'>
          <div className='relative text-white dark:text-dark text-center md:text-start z-10'>
            <p className='text-inherit text-xm font-medium'>Worldwide</p>
  ...
  <Icon icon="iconoir:delivery-truck" width={32} className="text-black dark:text-white" />
  <p className='text-sm sm:text-base font-normal text-inherit'>200+ Vehicles</p>
</div>

<div className='flex flex-col sm:items-center gap-3'>
  <Icon icon="iconoir:globe" width={32} className="text-black dark:text-white" />
  <p className='text-sm sm:text-base font-normal text-inherit'>Nationwide Coverage</p>
</div>

<div className='flex flex-col sm:items-center gap-3'>
  <Icon icon="material-symbols:schedule-send-rounded" width={32} className="text-black dark:text-white" />
  <p className='text-sm sm:text-base font-normal text-inherit'>24/7 Delivery</p>
</div>
