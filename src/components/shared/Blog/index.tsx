...
const BlogSmall: React.FC = () => {
    // Fetch latest 3 posts, ensure string types
                ...
                <div className='flex justify-between md:items-end items-start mb-10 md:flex-row flex-col'>
                    <div>
                        <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2">
                            <Icon icon="mdi:truck-delivery-outline" className="text-2xl text-primary" aria-label="Logistics icon" />
                            News & Updates
                        </p>
                        <h2 className="lg:text-52 text-40 font-medium dark:text-white">
                            Logistics & Transportation Insights
                        </h2>
                        <p className='text-dark/50 dark:text-white/50 text-sm max-w-md'>
                            Stay informed with the latest trends, tips, and updates from the logistics and transportation industry.
                        </p>
                    </div>
                    <Link
                        href="/blogs"
                        className='bg-dark dark:bg-white text-white dark:text-dark py-4 px-8 rounded-full hover:bg-primary duration-300'
                        aria-label="Read all logistics blog articles"
                    >
                        Read all updates
                    </Link>
                </div>
